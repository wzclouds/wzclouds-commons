package com.github.wzclouds.security.aspect;
...
public class UriSecurityPreAuthAspect implements ApplicationContextAware {
     ...
     */
    @Around("execution(public * com.github.wzclouds.base.controller.*.*(..)) || " +
            "@annotation(com.github.wzclouds.security.annotation.PreAuth) || " +
            "@within(com.github.wzclouds.security.annotation.PreAuth)"
    )
