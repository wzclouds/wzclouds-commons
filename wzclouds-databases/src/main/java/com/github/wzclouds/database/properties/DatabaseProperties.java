package com.github.wzclouds.database.properties;
...
import static com.github.wzclouds.database.properties.DatabaseProperties.PREFIX;
import static com.github.wzclouds.database.properties.MultiTenantType.SCHEMA;
...
public class DatabaseProperties {
    public static final String PREFIX = "wzclouds.database";
    /**
     * 是否启用 防止全表更新与删除插件
     *
     * @return
     ...
     * 租户库 前缀
     */
    private String tenantDatabasePrefix = "wzclouds_base";
     ...
     * 事务扫描基础包
     */
    private String transactionScanPackage = "com.github.wzclouds";
