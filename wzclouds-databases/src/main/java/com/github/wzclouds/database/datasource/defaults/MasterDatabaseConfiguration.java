package com.github.wzclouds.database.datasource.defaults;
...
import com.github.wzclouds.database.datasource.BaseDatabaseConfiguration;
 ...
 * <p>
 * 1. 本类的子类的 @MapperScan(basePackages = {"com.github.wzclouds"}) 修改为  @MapperScan(basePackages = {"com.github.wzclouds.product.dao"})
 ...
 * 3. 在wzclouds-xxx-server层复制该类，重命名为 SlaveDatabaseAutoConfiguration （跟AuthorityDatabaseAutoConfiguration放一起）
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"com.github.wzclouds"}, 修改为  basePackages = {"com.github.wzclouds.order.dao"} # 这个路径根据你的情况修改
 ...
 * <p>
 * 完成上述修改后， 位于com.github.wzclouds.product.dao 包下的dao 将操作  master 库， com.github.wzclouds.order.dao中的dao 将操作slave库
 *
 * @author wzclouds
