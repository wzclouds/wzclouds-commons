package com.github.wzclouds.log.aspect;
...
import com.github.wzclouds.context.BaseContextConstants;
import com.github.wzclouds.context.BaseContextHandler;
import com.github.wzclouds.context.ThreadLocalParam;
...
import com.github.wzclouds.log.event.SysLogEvent;
import com.github.wzclouds.log.util.LogUtil;
import com.github.wzclouds.utils.SpringUtils;
import com.github.wzclouds.utils.StrPool;
...
public class SysLogAspect {
     ...
     *
     * execution(public * com.github.wzclouds.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* com.github.wzclouds.base.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(com.github.wzclouds.log.annotation.SysLog) 解释：
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.github.wzclouds.base.controller.*.*(..)) || @annotation(com.github.wzclouds.log.annotation.SysLog)")
